...
Now you will need to create and change 2 images and a gif in the `public/config/images` folder, `bg.jpg`, `example.gif` and `logo.png`.
...
`public/logo512.jpg` to your brand images.
